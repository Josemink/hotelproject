...
<nav id="sidebar" class='mx-lt-5' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=categories" class="nav-item nav-categories"><span class='icon-field'><i class="fa fa-list"></i></span>แบบฟอร์มเพิ่มประเภทห้องพัก</a>
				<a href="index.php?page=rooms" class="nav-item nav-rooms"><span class='icon-field'><i class="fa fa-bed"></i></span>จัดการห้องพัก </a>
