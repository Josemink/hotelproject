	...
	<div class="card col-lg-12">
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<center>
					<button class="btn btn-info btn-primary btn-block col-md-2">บันทึก</button>
				</center>
			</form>
		</div>
	</div>
